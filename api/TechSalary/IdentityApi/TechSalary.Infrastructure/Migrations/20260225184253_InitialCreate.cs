    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerCode = table.Column<string>(type: "character varying(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Customers_CustomerCode",
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerCode", "CreatedAt", "CustomerName" },
                values: new object[,]
                {
                    { "C001", new DateTime(2026, 2, 25, 18, 42, 53, 466, DateTimeKind.Utc).AddTicks(170), "John Doe Enterprises" },
                    { "C002", new DateTime(2026, 2, 25, 18, 42, 53, 466, DateTimeKind.Utc).AddTicks(171), "Lanka Traders Pvt Ltd" },
                    { "C003", new DateTime(2026, 2, 25, 18, 42, 53, 466, DateTimeKind.Utc).AddTicks(172), "ABC Solutions" }
                });
